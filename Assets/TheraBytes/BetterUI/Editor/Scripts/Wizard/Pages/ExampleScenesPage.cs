...
namespace TheraBytes.BetterUi.Editor
{
    public class ExampleScenesPage : WizardPage
    {
        ...
        protected override void OnInitialize()
        {
            ...
            Add(new InfoWizardPageElement("This example shows Better UIs navigation features for gamepads."));
        ...
        {
            string package = System.IO.Path.Combine(Application.dataPath, string.Format("TheraBytes/BetterUI/packages/Example_{0}.unitypackage", exampleName));
            string folder = System.IO.Path.Combine(Application.dataPath, string.Format("TheraBytes/BetterUI_Examples/{0}", exampleName));
