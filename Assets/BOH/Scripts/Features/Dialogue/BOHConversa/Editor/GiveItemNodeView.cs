...
{
    public class GiveItemNodeView : BaseNodeView<GiveItemNode>
    {
        protected override string Title => "Give Item";

        public GiveItemNodeView(Conversation conversation) : base(new GiveItemNode(), conversation) { }
        public GiveItemNodeView(GiveItemNode data, Conversation conversation) : base(data, conversation) { }

        protected override void SetBody()
        {
            var itemFieldInfo  = typeof(GiveItemNode).GetField("item",  BindingFlags.NonPublic | BindingFlags.Instance);
            var countFieldInfo = typeof(GiveItemNode).GetField("count", BindingFlags.NonPublic | BindingFlags.Instance);
